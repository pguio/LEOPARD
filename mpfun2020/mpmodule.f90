...
private &
  mpabrt, mpabs, mpadd, mpcabs, mpcadd, mpcdiv, mpceq, mpcmul, mpcnpwr, mpconjg, &
  mpcsqrt, mpcsub, mpcpr, mpdecmdr, mpdiv, mpdivd, mpdivd40, mpdmc, mpdmc40, mpeq, &
  mpinfr, mpinitwds, mpmdc, mpmul, mpmuld, mpmuld40, mpneg, mpnint, mpnorm, mpnpwr, &
  mpnrtr, mprandr, mprealdp, mprealin, mproun, mpspacer, mpsgn, mpsqrt, mpsub, &
  mpwprecr, mpmqc, mpqmc, mpqmc90, mpfftcr, mpfftrc, mpfft1, mpfft2, mpfft3, &
  mpinifft, mplconv, mpmulx

!   Private subroutine names in module MPFUNC:

private &
  mpctomp, mpdigin, mpdigout, mpeformat, mpfformat, mpinp, mpout, mprealch
